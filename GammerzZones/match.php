...
<body>
    ...
    <ul class="nav navbar-nav">
      <li><a href="profile3.php">Profile</a></li>
        ...
        <li><a href="inabout.php">About</a></li>
        <li><a href="incontact.php">Contact Us</a></li>
        </ul>
	...
	<div class="container">
	   <div class="jumbotron">
		   <h1>GamerzZones</h1>
		   <p>Enter Matches With A Very Lower Price And Win Huge.</p>
...
<div class = "modal fade" id = "myModal10" tabindex = "-1" role = "dialog" 
 ...
 <div class = "modal fade" id = "myModalshowplayer1" tabindex = "-1" role = "dialog"  aria-labelledby = "myModalLabel" aria-hidden = "true">
  ...
  <div class="footer" style="color: black; margin-right: -3%; opacity: 0.8; float:right;font-size: 140%"><b>Copyright &copy 2019 All Rights Reserved.</b></div>
